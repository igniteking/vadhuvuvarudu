...
<div class="row mt-12">
      <h2 class="col-md-4" id="subhead">Requests! <lord-icon
      ...
      <?php
        ...
        $gender = $rows['gender'];
          ...
          <form class='col-sm' method='POST' action='request.php'>
          ...
          <form class='col-sm' method='POST' action='request.php'>
          <input type='submit' value='Accept Request' name='accept_request' style='float: right; margin-left: 70px; width: 150px;' class='btn btn-outline-primary'>
          </form>
          <a href='profile.php?id=$id'><div class='col-sm'><div style='background: #666; padding-top: 8px; margin-right: 10px; padding-bottom: 8px; padding-left: 10px; padding-right: 10px; float: left;'>
