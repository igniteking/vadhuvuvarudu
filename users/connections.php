...
<head>
  ...
  ?>
  <title>Connections! - Vadhuvuvarudu</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div id="content" class="p-4 p-md-5">
    ...
    <div class="row mt-12">
      <h2 class="col-md-4" id="subhead" style="color: white;">Connections! </h2><br><Br>
      <div class="table-responsive">
        <table class='table table-hover' style="background-color:#fff; border-radius: 10px;">
          ...
          <td><img data-enlargeable style'cursor: zoom-in;' src='"; ?><?php if ($gender == "male") {
                                                                        echo "images/male.jpg";
                                                                      } else {
                                                                        echo "images/female.jpg";
                                                                      } ?><?php echo "' width='100' height='100'></td>
          <td><a href='profile_view.php?id=$id'><button style='float: right; width: 100%;' class='btn btn-outline-primary'>View Profile</button></a><br><br>
          <form method='POST' action='connections.php'>
          <input type='submit' value='Delete Request' name='delete_request' style='float: right; width: 100%;' class='btn btn-outline-danger' />
          </form> <form method='POST' action='connections.php'><br><br>
          <input type='submit' value='Delete Connection' name='delete_connection' style='float: right; width: 100%;' class='btn btn-outline-secondary'><br><br>
          </form></td>
        </tr>";
                } else {
      ...
      <?php echo " <td><a href='profile_view.php?id=$id'><button style='float: right; width: 100%;' class='btn btn-outline-primary'>View Profile</button></a>
                <form method='POST' action='connections.php'>
                <input type='submit' value='Delete Request' name='delete_request' style='float: right; width: 100%;' class='btn btn-outline-danger' />
                </form>
                 <form method='POST' action='connections.php'>
                <input type='submit' value='Delete Connection' name='delete_connection' style='float: right; width: 100%;' class='btn btn-outline-secondary'>
                </form></td>
              </tr>
            ";
                }
