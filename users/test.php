...
<body>
    ...
    <center>
        ...
        <z style="color : #e63946; font-size: 24px;">Account Area</z>
    </center><br><Br>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-6" style="border-right: 1px solid black">
                <center>
                    <z style="color :  #e63946; font-size: 20px;">User Login Area</z>
                </center>
                <center>
                <?php $email_error = "";
				$password_error = ""; ?>
            ...
            <div class="col-6">
                <center>
                    <z style="color :  #e63946; font-size: 20px;">User Registeration Area</z>
                </center>
                <center>
    ...
    ?>
                    <form action="login.php" method="POST"><br>
                        ...
                        <input type="number" name="mobile" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock">
