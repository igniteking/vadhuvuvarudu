...
<body>
    <div id="content" class="p-4 p-md-5">
        ...
        if (isset($_POST['save_profile'])) {
         ...
         `age`='$age', `height`='$height', `parent_details`='$parent_details', `hobbies`='$hobbies', `expectations`='$expectations' WHERE email='$email'";
                ...
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5">
                        ...
                        <form method="post" action="profile.php?email=<?php echo $email; ?>">
                            <div class="row mt-2">
                                <div class="col-md-12"><label class="labels">Full Name</label><input type="text" name="username" class="form-control" placeholder="Your name" value="<?php echo $user ?>"></div>
                            </div>
                            <div class="row mt-3">
