...
<a href="http://vadhuvuvarudu.in/contact/" class="float" target="_blank">
<i class="fas fa-headset my-float"></i>
</a>
<style>.float{
	position:fixed;
	width:60px;
...
.my-float{
    ...
    <div class="row" style="padding: 15px;">
        <div class="col-4">
            <a href="http://vadhuvuvarudu.in"><img src="images/logo.png" style="float: right;" alt="" width="150"></a>
        </div>
        <div class="col-8">
            <h2>Vadhuvu Varudu</h2>
            <h3>Brahmana Vivaha Parichaya Vedika</h3>
        </div>
    </div>
